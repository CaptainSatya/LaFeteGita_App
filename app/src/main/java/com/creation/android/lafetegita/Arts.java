...
public class Arts extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_arts, contentFrameLayout);
        ...
        details_ui_hack_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Arts.this, DetailsUI_Hack.class);
        ...
        details_3d_hack_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Arts.this, Details3D_Hack.class);
                startActivity(intent);
            }
        });
